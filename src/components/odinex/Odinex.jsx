...
export default function Odinex() {
  return (
    <div className="OnlineShope learnEnglish">
      <h3 className="title-onlineShope-mobile title-learn">Odinex</h3>
      <div className="onlineShope-img">
        <img src="./images/202.svg" alt="Frame102" />
      </div>
      <div className="onlineShope-text odin">
        <h3 className="title-onlineShope-laptop title-learn">Odinex</h3>
